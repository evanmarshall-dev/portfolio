  ...
  return (
    <div className="relative flex cursor-pointer group">
      ...
      <motion.img
        ...
        src="/css3-logo.svg"
        className="object-cover w-24 h-24 transition duration-300 ease-in-out border border-gray-500 rounded-full xl:h-32 xl:w-32 md:w-28 md:h-28 filter group-hover:grayscale"
      />
